...
public class Modal implements View.OnClickListener {
	...
	private void findView() {
		...
		mPicContainer = mModalContainer
				.findViewById(R.id.modal_goods_pic_container);
		mGoodsCountContainer = mModalContainer
				.findViewById(R.id.modal_goods_count_container);
		mOperationContainer = mModalContainer
				.findViewById(R.id.modal_goods_operation_container);
		mGoodsPic = (SmartImageView) mModalContainer
				.findViewById(R.id.modal_goods_pic);
		mTextGoodsName = (TextView) mModalContainer
				.findViewById(R.id.modal_goods_name);
		mTextGoodsPrice = (TextView) mModalContainer
				.findViewById(R.id.modal_goods_price);
		mTextGoodsNum = (TextView) mModalContainer
				.findViewById(R.id.modal_goods_count_goods_num);
		mPlusButton = (ImageButton) mModalContainer
				.findViewById(R.id.modal_plus_button);
		mMinusButton = (ImageButton) mModalContainer
				.findViewById(R.id.modal_minus_button);
		mtotalPrice = (TextView) mModalContainer
				.findViewById(R.id.modal_totalPrice);
		// mWaitButton = (Button) mModalContainer
		// .findViewById(R.id.modal_wait_button);
		// mCancleButton = (Button) mModalContainer
		// .findViewById(R.id.modal_cancle_button);
	...
	public void setImageUrl(String url) {
		...
		// setPicContainerSize(pic.getIntrinsicWidth(),
	...
	private void setPicContainerSize(int width, int height) {
		mPicContainer.setLayoutParams(new LinearLayout.LayoutParams(width,
				height));
	}
	...
	public void setGoodsNum(int num) {
		...
		if (num > 0) {
			mGoodsCountContainer
					.setBackgroundResource(R.drawable.modal_goods_bright_bg);
		} else {
			mGoodsCountContainer
					.setBackgroundResource(R.drawable.modal_goods_dim_bg);
		}
	}
	...
	public void onPlus() {
		...
		mGoodsCountContainer
				.setBackgroundResource(R.drawable.modal_goods_bright_bg);
		setTotalPrice(mGoodsNum, mGoodsPrice);
 ...
 */
	public void setTotalPrice(int number, float price) {
		if (number == 0) {
			...
			mtotalPrice
					.setText(price + " × " + number + " = " + number * price);
		}
	}
	/**
	 * 删除按钮
	...
	private void onDismiss() {
		...
		FragmentManager ft = ((FragmentActivity) mContext)
